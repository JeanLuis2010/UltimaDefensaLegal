...
/* ===== Header + Footer HTML (with EN/ES toggle) ===== */
function udlHeaderHTML(){return `
<header>
  <div class="wrap">
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  udlSetHeaderHeight();
  window.addEventListener('resize',udlSetHeaderHeight,{passive:true});
